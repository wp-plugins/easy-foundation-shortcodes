...
if (typeof (Foundation) == 'undefined' ) {
    ...
    flag=false;
}else if(Foundation.libs.accordion!='undefined' || Foundation.libs.alerts!='undefined' || Foundation.libs.dropdown!='undefined' || Foundation.libs.equalizer!='undefined' || Foundation.libs.interchange!='undefined' || Foundation.libs.tab!='undefined' || Foundation.libs.tooltip!='undefined' || Foundation.libs.topbar!='undefined' ){
    osCitasGlobalVar = true;
    flag=false;
}
if(!flag){
