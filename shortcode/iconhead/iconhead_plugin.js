(function() {
    tinymce.create('tinymce.plugins.oscitasEFSIconhead', {
        init: function(ed, url) {
            ed.addButton('oscitasefsiconhead', {
                title: 'Icon Heading Shortcode',
                image: url + '/icon.png',
                onclick: function() {
                    create_oscitas_efs_iconhead();
                }
            });
        },
    ...
    jQuery(html).dialog({
        ...
        open:function(){
            ...
            table.find('#oscitas-heading-icon li').click(function(){
                ...
                jQuery('#osc_show_iconlist').hide();
                jQuery('#osc_show_icon').removeClass().addClass('fi').addClass(val);
                jQuery('#osc_icon_class_val').val(val);
            })
            //    // handles the click event of the submit button
            content.find('#oscitas-iconhead-submit').click(function() {
